...
# KOMODO_KEY and KOMODO_SECRET must be set in the environment; no hardcoded defaults.
KOMODO_KEY="${KOMODO_KEY:?KOMODO_KEY is required — set it in your environment before running rollback.sh}"
KOMODO_SECRET="${KOMODO_SECRET:?KOMODO_SECRET is required — set it in your environment before running rollback.sh}"
